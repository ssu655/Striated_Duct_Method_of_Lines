...
%
% the [] after field names indicates the dimension of vector, otherwise it
% contains a single number
% N_tot: number of cells along lumen
% N_int: number of intervals in lumen
% vector variable contains one value for each cell along the duct
%
%    fields      sub-fields
% 
